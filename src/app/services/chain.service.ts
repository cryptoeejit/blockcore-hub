    ...
    constructor(private log: Logger) {
        ...
        if (!ChainService.singletonInstance) {
            ...
            this.availableChains = [
                ...
                { opreturndata: 80, pos: true, rootFolderName: 'serf', test: false, name: 'serf', chain: 'serf', private: 160, public: 63, identity: 'serf', tooltip: 'serf', port: 15111, rpcPort: 15112, apiPort: 15113, network: 'serfMain', genesisDate: new Date(Date.UTC(2021, 4, 7)) },
                { opreturndata: 80, pos: true, rootFolderName: 'chaincoinX', test: false, name: 'ChaincoinX', chain: 'ChaincoinX', private: 160, public: 28, identity: 'ChaincoinX', tooltip: 'ChaincoinX', port: 11884, rpcPort: 11885, apiPort: 11886, network: 'ChaincoinXMain', genesisDate: new Date(Date.UTC(2022, 3, 18)) },
